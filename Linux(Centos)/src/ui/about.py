...
class AboutInterface(QWidget):
    def __init__(self, parent=None):
        ...
        if os.path.exists("assets/PyStart.png"):
            pixmap = QPixmap("assets/PyStart.png").scaled(96, 96, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)
        ...
        self.license_note_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.layout.addWidget(self.contact_container, 0, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignBottom)
