...
from PyQt5.QtWidgets import QAction, QVBoxLayout, QHBoxLayout, QWidget, QSplitter, QFileDialog, QFrame, QShortcut
from PyQt5.QtGui import QIcon, QKeySequence, QColor, QFontMetrics
...
class MainWindow(FluentWindow):
    def __init__(self):
        ...
        # 优先使用 .ico 以获得更好的 Windows 任务栏兼容性
    ...
    def show_terminal_menu(self, pos, terminal_widget=None):
        ...
        menu.exec_(terminal_widget.mapToGlobal(pos))
